cmd_scripts/dtc/livetree.o := gcc -Wp,-MD,scripts/dtc/.livetree.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc -Iscripts/dtc  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/libfdt -Iscripts/dtc/libfdt -c -o scripts/dtc/livetree.o /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/livetree.c

source_scripts/dtc/livetree.o := /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/livetree.c
