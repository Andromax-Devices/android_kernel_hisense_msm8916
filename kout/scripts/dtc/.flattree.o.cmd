cmd_scripts/dtc/flattree.o := gcc -Wp,-MD,scripts/dtc/.flattree.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc -Iscripts/dtc  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/libfdt -Iscripts/dtc/libfdt -c -o scripts/dtc/flattree.o /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/flattree.c

source_scripts/dtc/flattree.o := /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/flattree.c
