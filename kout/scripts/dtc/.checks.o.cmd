cmd_scripts/dtc/checks.o := gcc -Wp,-MD,scripts/dtc/.checks.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc -Iscripts/dtc  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/libfdt -Iscripts/dtc/libfdt -c -o scripts/dtc/checks.o /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/checks.c

source_scripts/dtc/checks.o := /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/checks.c
