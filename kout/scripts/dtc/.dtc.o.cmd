cmd_scripts/dtc/dtc.o := gcc -Wp,-MD,scripts/dtc/.dtc.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc -Iscripts/dtc  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/libfdt -Iscripts/dtc/libfdt -c -o scripts/dtc/dtc.o /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/dtc.c

source_scripts/dtc/dtc.o := /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/dtc.c
...
deps_scripts/dtc/dtc.o := \
  ...
  /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/version_gen.h \
