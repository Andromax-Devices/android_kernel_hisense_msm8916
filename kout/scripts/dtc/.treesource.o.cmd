cmd_scripts/dtc/treesource.o := gcc -Wp,-MD,scripts/dtc/.treesource.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc -Iscripts/dtc  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/libfdt -Iscripts/dtc/libfdt -c -o scripts/dtc/treesource.o /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/treesource.c

source_scripts/dtc/treesource.o := /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/treesource.c
