cmd_scripts/dtc/srcpos.o := gcc -Wp,-MD,scripts/dtc/.srcpos.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc -Iscripts/dtc  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/libfdt -Iscripts/dtc/libfdt -c -o scripts/dtc/srcpos.o /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/srcpos.c

source_scripts/dtc/srcpos.o := /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/srcpos.c
