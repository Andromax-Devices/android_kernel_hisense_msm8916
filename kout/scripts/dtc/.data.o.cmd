cmd_scripts/dtc/data.o := gcc -Wp,-MD,scripts/dtc/.data.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc -Iscripts/dtc  -I/cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/libfdt -Iscripts/dtc/libfdt -c -o scripts/dtc/data.o /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/data.c

source_scripts/dtc/data.o := /cygdrive/d/BaiduYunDownload/Hisense_kernel/scripts/dtc/data.c
